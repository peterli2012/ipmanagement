...
public class DeviceModelAction extends BaseTableAction<DeviceModelBusiness> {
   ...
   */
    ...
    public TableInitVo getTableInit() {
        ...
        init.getAoColumns().add(new TableHeaderVo("devtype", "Device Type").addSearchOptions(devices).enableSearch());
        init.getAoColumns().add(new TableHeaderVo("name", "Model Name").enableSearch());
        return init;
    }
